...
#define CUSTOM_MACHINE_NAME "Jerry's 3D Printer"
...
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2559, 98 }
...
#define PROBING_MARGIN 10 // MIN_PROBE_EDGE is now called PROBING_MARGIN

// X and Y axis travel speed (mm/min) between probes
// #define XY_PROBE_FEEDRATE (133*60)
#define XY_PROBE_FEEDRATE (50*60) // XY_PROBE_SPEED is now called XY_PROBE_FEEDRATE

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (4*60) // Z_PROBE_SPEED_FAST is now called Z_PROBE_FEEDRATE_FAST

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 2) // Z_PROBE_SPEED_SLOW is now called Z_PROBE_FEEDRATE_SLOW
